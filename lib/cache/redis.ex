defmodule Cache.Redis do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      def json_get(key) do
        @cache_adapter.json_get(@cache_name, key, nil, @adapter_opts)
      end
      ...
      def json_set(key, value) do
        @cache_adapter.json_set(@cache_name, key, nil, value, @adapter_opts)
      end
      ...
      def json_incr(key, path) do
        @cache_adapter.json_incr(@cache_name, key, path, @adapter_opts)
      end
