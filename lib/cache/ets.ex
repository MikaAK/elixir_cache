  ...
  * Support for atomic counter operations
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      @doc """
      Returns the first key and object(s) in the table.
      """
      def first_lookup do
      ...
      @doc """
      Returns the last key and object(s) in the table.
      """
      def last_lookup do
      ...
      @doc """
      Returns the Pos:th element of the object with the given key, or default if not found.
      """
      ...
      @doc """
      Returns the next key and object(s) following the given key.
      """
      ...
      @doc """
      Returns the previous key and object(s) preceding the given key.
      """
      ...
      @doc """
      Updates specific elements of an object with a default.
      """
